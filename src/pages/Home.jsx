                  ...
                  return (
                    <div key={element.id} className="card mb-4">
                      <div className="card-body">
                        ...
                        <button className="btnEdit  me-2 mt-1" onClick={() => tampil(element.id)}>
                          <span>
                           <BsPencilSquare/>
                          </span>
                        </button>

                        <button className="btnHapus mt-1" onClick={() => deleted(element.id)}>
                          <span>
                           <BsTrashFill/>
                          </span>
                        </button>
                    ...
                    return (
                      <div key={element.id} className="card mb-4">
                        <div className="card-body">
                          ...
                          <button className="btnEdit  me-2 mt-1">
                            <span>
                            <BsPencilSquare/>
                            </span>
                          </button>
